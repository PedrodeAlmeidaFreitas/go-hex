...
import (
	...
	application "github.com/PedrodeAlmeidaFreitas/go-hex/application"
...
// Get indicates an expected call of Get.
func (mr *MockProductPersistanceInterfaceMockRecorder) Get(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Save indicates an expected call of Save.
func (mr *MockProductPersistanceInterfaceMockRecorder) Save(product any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
